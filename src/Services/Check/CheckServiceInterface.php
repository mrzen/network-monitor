...
namespace NetworkMonitor\Services\Check;

/**
 * Check Service Interface
 *
 */
interface CheckServiceInterface extends \Pimple\ServiceProviderInterface
{
    ...
    /**
     * Method to retrive the success of the check
     *
